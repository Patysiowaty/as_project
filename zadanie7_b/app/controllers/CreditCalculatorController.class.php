...
class CreditCalculatorController
{
    ...
    {
        getSmarty()->assign('page_title', 'Ex7. Credit calculator');
        ...
        getSmarty()->display(getConf()->getRootPath() . '/app/views/CalcView.tpl');
    }

    public function actionShowCalculator(): void
    {
        $this->render();
    }
}