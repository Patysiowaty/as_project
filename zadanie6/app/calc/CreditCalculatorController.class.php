...
require_once $conf->getAppSrc() . '/calc/Messages.class.php';
require_once $conf->getAppSrc() . '/calc/CalcForm.class.php';
require_once $conf->getAppSrc() . '/calc/IController.class.php';
...
class CreditCalculatorController implements IController
{
    ...
    public function render(): void
    {
        ...
        $smarty->display($this->config->getAppSrc() . '/calc/CalcView.html');
    }
}