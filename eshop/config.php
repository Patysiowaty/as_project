...
$conf->app_root = '/eshop/public';   # project subfolder in domain (relative to main domain)

# ---- Database config - values required by Medoo
$conf->db_type = 'mysql';
$conf->db_server = 'localhost';
$conf->db_name = 'SHOP';
$conf->db_user = 'eshop_user';
$conf->db_pass = 'eshop_password'; // przykład jak nie robić :^)
